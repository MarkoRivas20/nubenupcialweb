                ...
                <ul class="space-y-4">
                    @foreach ($options as $option)
                        <li x-data="{
                            ...
                            <button x-on:click="open = !open" class="px-4 py-2 bg-gray-200 w-full text-left text-gray-700 flex justify-between items-center">
                                {{$option['name']}}
                                <i class="fa-solid fa-angle-up" x-bind:class="{
                                'fa-angle-up': open,
                                'fa-angle-down': !open
                                }"></i>
                            </button>
